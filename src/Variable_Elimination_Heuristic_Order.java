...
//import java.util.*;
//
//public class Variable_Elimination_Heuristic_Order {
//    /**
...
//     */
//    public Variable_Elimination_Heuristic_Order(DataCleaner dc) {
//        _dc = dc;
...
//        Collections.sort(_eliminationOrderList, Collections.reverseOrder());
...
//        _factorList.sort(Factor::compareTo);
//    }
//    private void abcAscendingOrdering(){
//        Collections.sort(_eliminationOrderList);
//    }
//
//    private void heuristicOrdering(){
//        Collections.sort(_eliminationOrderList, new Comparator<Variable>(){
//            public int compare(Variable v1, Variable v2){
//                if(v1.getParents().size() > v2.getParents().size())
//                    return 0;
//                return 1;
//            }
//        });
